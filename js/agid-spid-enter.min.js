window.agidSpidEnterConfig = {
    ...
    infoModal: function(htmlContent) {
        return [ '<div class="modal-content">', '<span id="closemodalbutton" class="close" role="button" tabindex="0" aria-label="Chiudi modale informativo"><b aria-hidden>&times;</b></span>', "<div>", htmlContent, "</div>", "</div>" ].join("");
    },
    nonHaiSpid: function() {
    ...
    function renderAvailableProviders(data) {
        ...
        hasSpidProviders = !0, document.querySelector("#agid-spid-panel-close-button").addEventListener("click", function() {
            hideProvidersPanel();
    ...
    function renderSpidButtons() {
        ...
        } else console.error("Si è verificato un errore nel caricamento dei providers, impossibile renderizzare i pulsanti SPID");
    }
    ...
    function openInfoModal(htmlContent) {
        ...
        infoModal.focus(), document.querySelector("#closemodalbutton").addEventListener("click", function() {
            closeInfoModal();
        });
    }
    ...
    function getAvailableProviders() {
        return ajaxRequest("GET", agidSpidEnterConfig.spidProvidersEndpoint).then(renderAvailableProviders).then(renderSpidButtons).catch(function(e) {
    ...
    return renderSpidModalContainer(), getAvailableProviders().then(getSelectors).then(bindEscKeyEvent), 
    {
