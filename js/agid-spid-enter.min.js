...
window.AgidSpidEnter.prototype.tpl = {
    ...
    spidProviderButton: function(providerData) {
        var providerHiddenName = "provider", providerPayloadInputs = "", providerTitle = providerData.isActive ? this.getI18n("accedi_con_idp", providerData.title) : this.getI18n("idp_disabled");
