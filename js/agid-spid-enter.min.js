window.AgidSpidEnter = function() {
    ...
    function showProvidersPanel() {
        var toshow = spidPanelSelect, base = document.querySelector("#agid-spid-button-anim-base"), panel = document.querySelector("#agid-spid-button-anim"), buttons = document.querySelector(".agid-spid-enter-button"), hiddenattribute;
        shuffleIdp();
