...
window.agidSpidEnterTpl = {
    ...
    function openInfoModal(htmlContent) {
        ...
        modal.innerHTML = agidSpidEnterTpl.infoModal(htmlContent), modal.style.display = "block", 
    ...
    document.addEventListener("keyup", function(e) {
        var providersPanel = document.querySelector("#agid-spid-panel-select"), infoModal = document.querySelector("#agid-infomodal"), isEscKeyHit = 27 === e.keyCode, isprovidersPanelVisible = "none" !== providersPanel.style.display, isInfoModalVisible = "none" !== infoModal.style.display;
        isEscKeyHit && isInfoModalVisible ? closeInfoModal() : isEscKeyHit && isprovidersPanelVisible && hideProvidersPanel();
    }), {
