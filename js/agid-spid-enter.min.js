...
window.agidSpidEnterConfig = {
    ...
    function getLocalisedMessages() {
        return ajaxRequest("GET", agidSpidEnterConfig.localisationEndpoint).then(function(i18nData) {
    ...
    function getAvailableProviders() {
        return ajaxRequest("GET", agidSpidEnterConfig.providersEndpoint).catch(function(error) {
