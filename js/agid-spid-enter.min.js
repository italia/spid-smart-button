window.agidSpidEnterConfig = {
    ...
    function ajaxRequest(method, url) {
        return new Promise(function(resolve, reject) {
            ...
            xhr.open(method, url), xhr.onreadystatechange = function() {
                4 === xhr.readyState && (200 === xhr.status ? resolve(JSON.parse(xhr.responseText)) : reject(xhr.responseText));
            }.bind(this), xhr.send();
        });
    }
    function getAvailableProviders() {
        ajaxRequest("GET", agidSpidEnterConfig.spidProvidersEndpoint).then(renderAvailableProviders);
    }
    ...
    return renderSpidModalContainer(), getAvailableProviders(), renderSpidButtons(), 
