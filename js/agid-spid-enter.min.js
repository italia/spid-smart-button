window.agidSpidEnterConfig = {
    ...
    spidMainContainers: function() {
        return [ '<link rel="stylesheet" href="css/agid-spid-enter.min.css">', '<div id="agid-infomodal" class="modal"></div>', '<div id="agid-spid-enter"></div>' ].join("");
    },
    ...
    infoModal: function(htmlContent) {
        return [ '<div class="modal-content">', '<span id="closemodalbutton" class="close" >&times;</span>', "<div>", htmlContent, "</div>", "</div>" ].join("");
    },
    nonHaiSpid: function() {
    ...
    function closeInfoModal() {
        var infoModal = document.querySelector("#agid-infomodal");
        infoModal.style.display = "none", infoModal.innerHTML = "";
    }
    ...
    function isElementVisible(selector) {
        return "none" !== document.querySelector(selector).style.display;
    }
    ...
    function bindEscKeyEvent() {
        document.addEventListener("keyup", function(e) {
            var isEscKeyHit = 27 === e.keyCode, isInfoModalVisible = isElementVisible("#agid-infomodal"), isprovidersPanelVisible = isElementVisible("#agid-spid-panel-select");
            isEscKeyHit && (isInfoModalVisible ? closeInfoModal() : isprovidersPanelVisible && hideProvidersPanel());
        });
    }
    var hasSpidProviders = !1;
    return renderSpidModalContainer(), getAvailableProviders().then(bindEscKeyEvent), 
    {
