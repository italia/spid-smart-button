...
function agid_spid_enter() {
    renderSpidModalContainer(), displaySPIDConfiguredProviders(), insertButtonS(), insertButtonM(), 
    insertButtonL(), insertButtonXl(), Array.from(document.querySelectorAll(".agid-spid-enter")).forEach(function(spidButton) {
...
var config = {
    ...
    spidMainContainers: function() {
        return [ '<div id="infomodal" class="modal"></div>', '<div id="agid-spid-enter"></div>' ].join("");
    },
