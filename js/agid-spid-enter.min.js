window.AgidSpidEnter = function() {
    var self = this, hasSpidProviders = false, infoModal, spidPanelSelect;
    ...
    function shuffleIdp() {
        var ul = document.querySelector("#agid-spid-idp-list"), i;
    ...
    function handleEscKeyEvent(event) {
        var isEscKeyHit = event.keyCode === 27, isInfoModalVisible = isElementVisible(infoModal), isProvidersPanelVisible = isElementVisible(spidPanelSelect);
        if (isEscKeyHit) {
    ...
    function renderAvailableProviders(data) {
        var agid_spid_enter = document.querySelector("#agid-spid-enter"), spidProvidersButtonsHTML = "", provider, providerData;
    ...
    function getSpidButtonsPlaceholders() {
        var spidButtonsPlaceholdersObj = document.querySelectorAll(".agid-spid-enter-button"), spidButtonsPlaceholdersArray = Array.from(spidButtonsPlaceholdersObj);
    ...
    function init() {
        ...
        return Promise.all(fetchData).then(function(data) {
            ...
            renderSpidButtons();
            getSelectors();
            document.querySelector("#agid-spid-button-anim").addEventListener("animationend", function() {
                spidPanelSelect.focus();
            }, true);
