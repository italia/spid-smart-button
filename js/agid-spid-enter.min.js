...
function showPanel(name) {
    var hiddenattribute, toshow = document.getElementById(name), base = document.getElementById("agid-spid-button-anim-base"), panel = document.getElementById("agid-spid-button-anim"), buttons = document.getElementsByClassName("agid-spid-enter-button");
