...
window.AgidSpidEnter.prototype.getI18n = function(labelKey) {
    var locale = this.language, copy = this.i18n.language && this.i18n.language[locale] && this.i18n.language[locale][labelKey];
