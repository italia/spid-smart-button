...
window.agidSpidEnterConfig = {
    ...
    return function() {
        ...
        Promise.all(fetchData).then(function(data) {
            window.agidSpidEnterI18n = data[0], renderSpidModalContainer(), renderAvailableProviders(data[1]);
        }).then(renderSpidButtons).then(getSelectors).then(bindEscKeyEvent).catch(function(error) {
