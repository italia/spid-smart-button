...
function renderSpidButtons() {
    ...
    Array.from(agid_spid_enter_buttons).forEach(function(spidButton) {
        ...
        -1 != supportedSizes.indexOf(dataSize) ? spidButton.innerHTML = spidTpl.spidButton(dataSize) : console.error("Le dimenioni supportate sono", supportedSizes, "trovato invece:", foundDataSize);
    });
}
