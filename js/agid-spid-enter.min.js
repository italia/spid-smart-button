window.AgidSpidEnter = function() {
    ...
    function renderAvailableProviders() {
        var agid_spid_enter = document.querySelector("#agid-spid-enter"), data = self.availableProviders, spidProvidersButtonsHTML = "", provider, providerData;
