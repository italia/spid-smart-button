...
window.AgidSpidEnter.prototype.tpl = {
    ...
    infoModal: function(htmlContent) {
        return [ '<div class="modal-content agid-font">', '<span id="closemodalbutton" class="close" role="button" tabindex="0" aria-label="', this.getI18n("aria_chiudi_modale"), '"><b aria-hidden="true">&times;</b></span>', "<div>", htmlContent, "</div>", "</div>" ].join("");
    },
    nonHaiSpid: function() {
