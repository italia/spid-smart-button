...
function showPanel(name) {
    var hiddenattribute, toshow = document.getElementById(name), base = document.querySelector("#agid-spid-button-anim-base"), panel = document.querySelector("#agid-spid-button-anim"), buttons = document.querySelector(".agid-spid-enter-button");
...
function hidePanel(name) {
    var tohide = document.getElementById(name), base = document.querySelector("#agid-spid-button-anim-base"), panel = document.querySelector("#agid-spid-button-anim"), buttons = document.querySelector(".agid-spid-enter-button"), hiddenattribute = document.createAttribute("hidden");
